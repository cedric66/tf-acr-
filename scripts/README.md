...
╔══════════════════════════════════════════════════════════╗
║   AKS DevOps Toolkit                                     ║
║   Comprehensive Azure Kubernetes Audit Suite             ║
╚══════════════════════════════════════════════════════════╝
...
```
scripts/
├── devops_toolkit.py      # Master controller (interactive menu)
├── discover.py            # Discovery script (generates CSVs)
├── spot_vm_pricing.py     # Spot VM availability & pricing
├── utils.py               # Shared utilities & error handling
├── requirements.txt       # Python dependencies
│
├── samples/               # Sample input files
│   ├── clusters.csv       # Example cluster inventory
│   ├── acrs.csv           # Example ACR inventory
│   └── config.json        # Example JSON config
│
└── [audit scripts]        # Individual audit scripts
```
